...
const trend_forecasting_1 = require("@/ai/flows/trend-forecasting"); // Ensure this is correctly implemented
const crypto = __importStar(require("crypto"));
const stripe_1 = __importDefault(require("stripe"));
const firebase_admin_1 = require("./firebase-admin"); // Ensure firebase-admin.ts is correctly configured
...
const authenticateAndRateLimit = async (req, res, next) => {
    ...
    try {
        ...
        logger.info(`API Key ${apiKey} used. Request count: ${newCount}/${tierLimit}`);
...
app.post('/v1/predict', authenticateAndRateLimit, async (req, res) => {
    ...
    try {
        ...
        if (cachedDoc.exists) {
            ...
            const cacheTime = data?.timestamp && typeof data.timestamp.toDate === 'function'
