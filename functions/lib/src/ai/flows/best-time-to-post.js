...
const BestTimeToPostInputSchema = genkit_2.z.object({
    ...
    platform: genkit_2.z.string().describe('The social media platform (e.g., TikTok, Instagram).'),
});
const BestTimeToPostOutputSchema = genkit_2.z.object({
    time: genkit_2.z.string().describe('The recommended posting time, including timezone (e.g., "9:00 AM EST").'),
    reasoning: genkit_2.z.string().describe('A brief explanation for the recommendation (e.g., "Highest engagement on Tuesdays").'),
});
