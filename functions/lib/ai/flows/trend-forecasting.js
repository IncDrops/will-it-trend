 ...
 */
const genkit_1 = require("../../genkit"); // Correct relative path to genkit.ts
const genkit_2 = require("genkit");
const googleai_1 = require("@genkit-ai/googleai"); // Import the specific model
...
const trendForecastFlow = genkit_1.ai.defineFlow({
    ...
    let rawAiResponseText; // To store the raw text for debugging
    try {
        const response = await genkit_1.ai.generate({
            model: googleai_1.geminiFlash, // Explicitly specify the model here
